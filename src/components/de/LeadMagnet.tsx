            ...
            <div className="flex flex-col lg:flex-row">
                  ...
                  >
                    <div className="px-4 pt-5 pb-3 flex-1 flex flex-col">
                      ...
                      <p className="text-[7px] md:text-[8px] text-muted-foreground leading-tight mb-3">
                        die Zugewanderte in Deutschland häufig machen
                      </p>
              ...
              <div className="lg:w-[65%] p-6 sm:p-8 lg:p-9 flex flex-col justify-center">
                ...
                <h3 className="font-[family-name:var(--font-serif)] text-xl sm:text-2xl font-bold text-navy mt-2 leading-snug">
                  7 Finanzfehler, die Zugewanderte in Deutschland häufig machen
                </h3>
                <p className="text-muted-foreground text-sm mt-2">
                  Erfahren Sie, welche typischen Fehler Sie jedes Jahr hunderte Euro kosten - und wie Sie diese vermeiden.
                </p>
                ...
                <p className="text-muted-foreground text-sm mt-5">
                  Der Ratgeber ist kostenlos im Telegram-Kanal verfügbar - abonnieren und sofort herunterladen.
                </p>
                ...
                <p className="text-muted-foreground text-xs mt-2.5 text-center">
                  Kein Spam - nur nützliche Inhalte zu Finanzen in Deutschland.
                </p>
              </div>
            </div>
          </div>
