...
const heroContent = {
  headline: "Особистий експерт",
  headlineAccent: "із фінансів у Німеччині",
  ...
  pills: [
    { text: "Іпотечне фінансування" },
    { text: "Страхування" },
    { text: "Інвестиції та фонди" },
    ...
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <div className="hidden md:block absolute inset-0">
          <Image
            src="/hero.png"
            alt="Фінансовий консультант у Німеччині"
          ...
          <div className="max-w-2xl text-center">
            ...
            >
              <a
                ...
                aria-label="Надіслати повідомлення у WhatsApp"
