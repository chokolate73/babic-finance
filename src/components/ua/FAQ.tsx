...
const faqs: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: "Для вас вони безкоштовні. Я працюю як Vermögensberater DVAG, а винагороду отримую від компаній-партнерів. Ви отримуєте незалежний аналіз і підбір найкращих рішень без додаткових витрат.",
  },
  {
  ...
  },
  {
    ...
    a: "Через DVAG я маю доступ до продуктів провідних страхових і банків Німеччини. Завдяки цьому можу для кожного клієнта обрати оптимальне рішення.",
  },
  {
