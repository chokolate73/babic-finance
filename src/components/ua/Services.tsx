...
const services = [
  ...
  },
  {
    ...
    desc: "Найкращі умови фінансування нерухомості в Німеччині. Порівнюємо пропозиції та знаходимо оптимальне рішення.",
  ...
  },
  {
    ...
    desc: "Освітні заходи з фінансової грамотності українською, російською та німецькою. Обговорюємо реальні питання у живому форматі.",
