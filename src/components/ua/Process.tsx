...
const steps = [
  {
    ...
    desc: "Через сайт, WhatsApp або телефоном",
  },
  {
    num: 2,
    title: "Безкоштовна розмова",
    desc: "Обговорюємо вашу ситуацію, цілі й побажання",
  },
  {
    num: 3,
    title: "Аналіз і підбір",
    desc: "Я розробляю персональні рішення під ваші потреби",
  },
  {
    num: 4,
    title: "Реалізація",
    desc: "Беремо на себе всі документи та формальності",
  },
  {
    num: 5,
    title: "Поточний супровід",
    desc: "Постійна підтримка та регулярний перегляд стратегії",
  },
];
