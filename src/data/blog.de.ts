...
export const articlesDe: BlogArticleDe[] = [
  {
    slug: "flottenversicherung-fuhrpark-leitfaden-2026",
    title: "Flottenversicherung für Ihren Fuhrpark: Der komplette Leitfaden 2026",
    excerpt:
      "Pflichtpolicen, Rahmenvertrag, Kosten und Schadenquote — alles, was Transportunternehmer in Deutschland 2026 zur Flottenversicherung wissen müssen.",
    date: "2026-04-30",
    readingTime: "14 Min.",
    image: "/flottenversicherung-lkw-fuhrpark.jpg",
    metaDescription:
      "Pflichtpolicen, Rahmenvertrag, Kosten und Schadenquote — alles, was Transportunternehmer in Deutschland 2026 zur Flottenversicherung wissen müssen.",
    primaryKeyword: "Flottenversicherung",
    content: `*Pflichtpolicen, Rahmenvertrag, Kosten und Schadenquote — was Transportunternehmer in Deutschland jetzt wissen müssen.*
...
## 5. Schadenquote — die zentrale Kennzahl
...
## 6. Checkliste: So wählen Sie die richtige Flottenversicherung
...
Die meisten Versicherer bieten Flottenkonditionen ab drei Fahrzeugen an. Der wirtschaftliche Effekt — günstigere Stückprämie, Flottennachlass, einheitlicher SF-Rabatt — wird ab fünf bis sieben Fahrzeugen deutlich spürbar. Unter drei Fahrzeugen sind Einzelpolicen meist die bessere Wahl.

**Kann ich Werkverkehr und gewerblichen Güterkraftverkehr in einem Vertrag haben?**
Ja, das ist im Rahmen einer Flottenversicherung möglich — vorausgesetzt, jedes Fahrzeug wird mit der korrekten Nutzungsart erfasst. Wichtig: Werkverkehr-Fahrzeuge brauchen **keine** Frachtführerhaftung nach § 7a GüKG, sehr wohl aber eine Werkverkehrsversicherung für die transportierte eigene Ware. Eine falsche Zuordnung kann im Schadenfall zur Leistungsablehnung führen.

**Was passiert nach einem Großschaden?**
Sie haben ein Sonderkündigungsrecht von vier Wochen — und der Versicherer ebenfalls. Bei Schäden über 50.000 € ist eine Beitragsanpassung praktisch sicher. Wichtig ist eine saubere Dokumentation: Polizeibericht, Fotos, Zeugenaussagen, technische Gutachten. Wer hier in den ersten 48 Stunden professionell agiert, vermeidet später Rückforderungen wegen "Obliegenheitsverletzung".

**Was kostet eine Flottenversicherung für 10 Lkw?**
Realistische Bandbreite: 25.000–60.000 € pro Jahr für Haftpflicht und Vollkasko — abhängig von Wagnisklasse, Schadenquote, Region und Selbstbehalt. Hinzu kommen die Verkehrshaftung (oft 600–1.500 € pro Fahrzeug) und optionale Bausteine. Eine seriöse Zahl liefert nur ein konkretes Angebot — pauschale Online-Rechner liegen bei Flotten regelmäßig daneben.

**Wie wechsle ich die Flottenversicherung?**
Der Wechsel ist kein Wochenend-Projekt — rechnen Sie mit drei bis sechs Monaten Vorlauf. Versichererwechselbescheinigung anfordern (Juli/August), drei bis fünf Angebote einholen (September), entscheiden (Oktober), bis 30. November kündigen, neuen Vertrag zum 1. Januar abschließen.

**Was ist eigentlich ein Phantomfrachtführer — und wie schütze ich mich?**
Eine Betrugsmasche, bei der Kriminelle als Subunternehmer auftreten, eine Ladung übernehmen und damit verschwinden. Der GDV hat allein in den ersten sieben Monaten 2025 88 Fälle registriert — so viele wie im gesamten Jahr 2024.
...
export function getArticleDeBySlug(slug: string): BlogArticleDe | undefined {
  return articlesDe.find((a) => a.slug === slug);
}

export function getAllSlugsDe(): string[] {
  return articlesDe.map((a) => a.slug);
}
