...
export const metadata: Metadata = {
  title: "Заявка отправлена | Babic Finance",
  description: "Заявка отправлена. Владислав свяжется в течение дня.",
...
const CARDS: Card[] = [
  {
    icon: "zap",
    title: "Хочешь ускорить процесс?",
    description:
      "Пройди официальный опросник DVAG «10 Fragen zum Traumberuf» — тогда у Владислава будет полная картина к моменту разговора.",
    ctaText: "Пройти опросник DVAG",
  ...
  {
    icon: "book",
    title: "Хочешь узнать больше?",
    description:
      "Почитай блог про работу финансового консультанта в Германии и жизнь в Троиздорфе.",
    ctaText: "К блогу",
    ctaHref: "/blog",
    accent: "navy",
  },
...
function CardIcon({ icon }: { icon: Card["icon"] }) {
  ...
  if (icon === "whatsapp") return <WhatsAppIcon className="w-6 h-6 text-whatsapp" />;
          ...
          <AnimateOnScroll animation="fade-up">
            <div className="text-center mb-14 max-w-2xl mx-auto">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mt-5 leading-relaxed">
                Владислав получил твои ответы и свяжется в течение дня через
                WhatsApp.
              </p>
            </div>
          </AnimateOnScroll>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {CARDS.map((card, i) => {
              const ctaStyles: Record<Card["accent"], string> = {
                ...
                whatsapp: "bg-whatsapp text-white hover:opacity-90 shadow-whatsapp/25",
