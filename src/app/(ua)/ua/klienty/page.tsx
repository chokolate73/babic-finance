...
export const metadata: Metadata = {
  title:
    "Особистий фінансовий консультант у Німеччині | Babic Finance",
  description:
    "Особистий фінансовий консультант у Німеччині. Інвестиції, страхування, пенсія, іпотека. DVAG.",
  alternates: {
  ...
  openGraph: {
    title:
      "Особистий фінансовий консультант у Німеччині",
    description:
