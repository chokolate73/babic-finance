...
const CARDS: Card[] = [
  ...
  {
    icon: "book",
    title: "Willst du mehr erfahren?",
    description:
      "Lies den Blog über die Arbeit als Finanzberater in Deutschland und das Leben in Troisdorf.",
    ctaText: "Zum Blog",
    ctaHref: "/blog",
    accent: "navy",
  },
...
export default function DeThankYouPage() {
  return (
    <div className="min-h-screen flex flex-col" lang="de">
      <Navbar forceDark />
